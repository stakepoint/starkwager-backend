...
pub trait IEscrow<TContractState> {
    ...
    fn distribute_funds(ref self: TContractState, wager_id: u64, winner: ContractAddress);
    fn refund_wager(
        ref self: TContractState, wager_id: u64, stake: u256, participants: Span<ContractAddress>
    );
}
